...
async function exampleToolTracking() {
	...
	await enhancedMemory.trackToolUsage("swarm_init", { topology: "invalid" }, null, 150, false, "Invalid topology specified")
...
async function exampleKnowledgeGraph() {
	...
	await enhancedMemory.addKnowledgeEntity("service", "JWTService", "src/auth/jwt.service.js", ["AuthModule", "ConfigService"], {
