 ...
 * Adapted from https://github.com/ruvnet/claude-flow
 */
...
/**
 * Default logger instance for Claude-Flow compatibility
 * This export provides the logger instance that Claude-Flow components expect
 */
export const logger: ILogger = Logger.getInstance()

/**
 * Console logger implementation for backward compatibility
 */
