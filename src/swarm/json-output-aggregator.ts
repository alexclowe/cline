...
import type { AgentState, SwarmMetrics, TaskDefinition, TaskResult } from "./types.js"
...
export class SwarmJsonOutputAggregator extends EventEmitter {
	...
	constructor(swarmId: string, objective: string, configuration: Record<string, any> = {}) {
		...
		this.logger = new Logger({ level: "info", format: "json", destination: "console" }, { component: "SwarmJsonAggregator" })
